                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="breadcrumb__wrapper">
                            <h2 class="breadcrumb__title"> Mizizi Classidieds Poperty Top Agents</h2>
                            <ul class="breadcrumb__list">
                                ...
                                <li class="breadcrumb__item"> <span class="breadcrumb__item-text"> Agents </span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <section class="team-two-section py-30">
            ...
            <div class="container">
                <div class="row row-gap-4 justify-content-centerx">
                     <?php foreach($this->data['agents'] as $row) { 
                        $img = $row['user_dp'];
                        ...
                        <div class="team-slide-item">
                            <div class="team-img">
                                <!-- <img src="assets/images/team/8.jpg" alt="team" class="img-fluid w-100"> -->
                                 <a href="/property/agents/<?= $row['user_url'] ?>">
                            ...
                            <div class="team-text">
                                ...
                                <h5><a href="/property/agents/<?= $row['user_url'] ?>"><?= $row['user_fname'] .' '. $row['user_lname'] ?></a></h5> 
                            </div>
                        </div>
                    </div>
                    <?php } ?>
