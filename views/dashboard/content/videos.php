                        ...
                        <div class='row'>
                            ...
                            <div class='col-md-10 table-responsive'>
                               <table class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    <?php $i = 0; foreach ($this->data['videos'] as $row) { $i++; ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td><a target='_blank' href='/content/<?php echo $row['v_url']; ?>' style='color:initial'><?php echo $row['v_title']; ?></a></td>
                                        <td>KES <?php echo $row['v_money_made']; ?></td>
                                        <td>
                                            <a href='#' class='deltvideo btn btn-sm badge-danger' rel='<?php echo $row['v_url']; ?>' title='Delete' style='color:initial'><i class='fa fa-trash'></i></a>
                                            <a  class=' btn btn-sm badge-success'  href='/dashboard/content/edit?vid=<?php echo $row['v_url']; ?>' title='Edit'  style='color:initial'><i class='fa fa-pencil'></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
