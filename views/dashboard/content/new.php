        ...
        <div class="content-wrapper px-4 py-2">
            ...
            <div class="content px-2">
                ...
                <div class='container alert'>
                    <div class=''>
                        <form id='newproduct'>
                            <input type="hidden" name="method" value="manage_blog" />
                            <input type="hidden" name="action" value="<?= !empty($this->data['id'])?"update":"insert" ?>" />
                            ...
                            <div class='row'>
                                ...
                                <div class='col-md-12 mb-2'>
                                    <div class='form-group'>
                                        ...
                                        <textarea name='meta_description' class='form-control' required><?= $this->data['meta']??"" ?></textarea>
                                    </div>
                                </div>
