        ...
        <div class="content-wrapper px-4 py-2">
            ...
            <div class="columns">
              <ul class="price">
                ...
                <li class=" " style='background:darkgrey' ><a href="/dashboard/promote/action?choice=silver" class="btn_info btn btn-block">Try it @KES 150</a></li>
              </ul>
            </div>
               <div class="columns">
              <ul class="price">
                ...
                <li class=" " style='background:skyblue'><a href="/dashboard/promote/action?choice=gold" class="btn_info btn btn-block">Try it @KES 240</a></li>
              </ul>
            </div>
               <div class="columns">
              <ul class="price">
                ...
                <li class=" " style='background:orange'><a href="/dashboard/promote/action?choice=platinum" class="btn_info btn btn-block">Try it @KES 350</a></li>
              </ul>
            </div>
